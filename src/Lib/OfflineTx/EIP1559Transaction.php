...
class EIP1559Transaction
{
    ...
    public function __construct(string $nonce = '', string $maxPriorityFeePerGas = '', string $maxFeePerGas = '',
        string $gasLimit = '', string $to = '', string $value = '', string $data = '')
    {
        $this->nonce                = $nonce;
