 ...
 * @method sendRawTransaction(callable $callback)
 * @method call(callable $callback)
 * @method estimateGas(callable $callback)
 * @method getBlockByHash(callable $callback)
 * @method getBlockByNumber(callable $callback)
 * @method getTransactionByHash(callable $callback)
