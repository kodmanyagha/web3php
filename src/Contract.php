...
use Kdm\Utils;
use Kdm\Eth;
use Kdm\Contracts\Ethabi;
use Kdm\Contracts\Types\Address;
use Kdm\Contracts\Types\Boolean;
use Kdm\Contracts\Types\Bytes;
use Kdm\Contracts\Types\DynamicBytes;
use Kdm\Contracts\Types\Integer;
use Kdm\Contracts\Types\Str;
use Kdm\Contracts\Types\Uinteger;
...
class Contract
{
     ...
     * @return $this
     */
    public function setDefaultBlock($defaultBlock): Contract
    {
        if (TagValidator::validate($defaultBlock) || QuantityValidator::validate($defaultBlock)) {
            $this->defaultBlock = $defaultBlock;
        } else {
